...
class TallyStockItemDataTable extends DataTable
{
    ...
    public function query(TallyStockItem $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('tallyStockItem-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('gst_applicable')->title(__('Gst Applicable')),
            Column::make('tax_classification_name')->title(__('Tax Classification Name')),
            Column::make('gst_type_of_supply')->title(__('GST Type of Supply')),
            // Column::make('appropriate_for')->title(__('APPROPRIATEFOR')),
            Column::make('costing_method')->title(__('Costing Method')),
            ...
            Column::make('language_name')->title(__('Language Name')),
            Column::make('language_id')->title(__('Language Id')),
        ];
    }
