...
class TallyGroupDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('grp_debit_parent')->title(__('Debit Parent')),
            Column::make('grp_credit_parent')->title(__('Credit Parent')),
            Column::make('affects_stock')->title(__('Affects Stock')),
