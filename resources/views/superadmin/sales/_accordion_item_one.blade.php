<div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            ...
            @if($saleItem->party_ledger_name)
                <p class="" style="margin-left: auto;">Bill to: {{ $saleItem->party_ledger_name }}</p>
            @endif
        </button>
    </h2>
    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            @foreach($ledgerData as $data)
                ...
                @endif
            @endforeach
            @if($saleItem->place_of_supply)
                <p class="mb-0 font-16">Place of supply: {{ $saleItem->place_of_supply }}</p>
            @endif
            @if($data->email)
