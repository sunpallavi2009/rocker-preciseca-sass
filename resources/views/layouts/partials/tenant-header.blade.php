                ...
                <nav class="navbar navbar-expand gap-3">
                                      ...
                                      <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/slack.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/behance.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                <img src="{{ url('assets/images/app/google-drive.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/outlook.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/github.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/stack-overflow.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/figma.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/twitter.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/google-calendar.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/spotify.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/google-photos.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/pinterest.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/linkedin.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/dribble.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                                  <p class="mb-0 mt-1">Dribble</p>
                                              </div>
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/youtube.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/google.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/envato.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                         ...
                                         <div class="col">
                                          <a href="javascript:;">
                                            <div class="app-box text-center">
                                              <div class="app-icon">
                                                  <img src="{{ url('assets/images/app/safari.png') }}" width="30" alt="">
                                              </div>
                                              <div class="app-name">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="notify bg-light-success text-success">
                                                    <img src="{{ url('assets/images/app/outlook.png') }}" width="25" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="notify bg-light-primary">
                                                    <img src="{{ url('assets/images/app/github.png') }}" width="25" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="header-message-list">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/11.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/02.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/03.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/04.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/05.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/06.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/07.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/08.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ url('assets/images/products/09.png') }}" class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
                    ...
                    <div class="user-box dropdown px-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info">
                                <p class="user-name mb-0">{{ __('Hi,') }} {{ Auth::user()->name }}</p>
                                {{-- <p class="designattion mb-0">Web Designer</p> --}}
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item d-flex align-items-center" href="{{ route('central.profile.show') }}"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
                            </li>
